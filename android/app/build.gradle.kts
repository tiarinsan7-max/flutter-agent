...
android {
    ...
    buildTypes {
        release {
            ...
            isMinifyEnabled = false  // Disabled due to R8 Play Core class issues
            isShrinkResources = false
            // ProGuard minification can be re-enabled after adding proper keep rules
            // proguardFiles(
